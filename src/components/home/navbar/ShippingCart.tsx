...
import { Button, Card, Divider, Drawer, Image, Input } from "antd";
import {
  CloseOutlined,
  MinusOutlined,
  PlusOutlined,
          ...
          <div className="flex justify-between items-center ">
            <span className="flex gap-3 text-[#3D3C3A] px-3">
              <ShoppingOutlined
                ...
                // onClick={toggleCart}
              />
              <h3 className="text-lg font-bold leading-[24px]">
                {" "}
                Bags ({totalItems})
              </h3>
            </span>
            ...
            >
              <CloseOutlined className="text-3xl md:text-4xl text-[#3D3C3A]" />
            </button>
          </div>
        }
        placement="right"
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="border border-[#CCCCCC] my-7">
              ...
              {/* standard sshipping */}
              <div className="flex justify-between p-5 border-b border-[#CCCCCC]">
                {" "}
                <div className="flex gap-5">
                  <input
                    type="radio"
          ...
          <Card className="font-[Century Gothic] flex flex-col gap-5 mt-4 md:mt-12 lg:mt-28">
            ...
            <div className="flex justify-between">
              ...
              <p className="text-sm font-bold md:text-lg text-[#3D3C3A] leading-[22px]">
                AED {FormatPrice(subtotal + 20)}
              </p>
            </div>
            <Button
              type="primary"
              htmlType="submit"
              className="mt-4 bg-[#757C5B] text-[#ffffff] px-12 py-5 text-[10px] md:text-[12px]  rounded-lg w-full border border-white  hover:bg-gray-300 transition-colors duration-300"
            >
              Checkout
            </Button>
          </Card>
